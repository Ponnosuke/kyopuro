...
void naive_solution1(int N, vector<vector<int>> &b, vector<Point> &op1, vector<Point> &op2, int &K){
    // K = 0;
    while(K < LOOP_MAX){
        bool out = true;
        for(int i = 0; i < N-1; i++){
...
void naive_solution2(int N, vector<vector<int>> &b, vector<Point> &op1, vector<Point> &op2, int &K){
    // K = 0;
    while(K < LOOP_MAX){
        bool out = true;
        for(int i = N-2; i >= 0; i--){
...
void naive_solution3(int N, vector<vector<int>> &b, vector<Point> &op1, vector<Point> &op2, int &K){
    // K = 0;
    while(K < LOOP_MAX){
        bool out = true;
        for(int i = 0; i < N-1; i++){
...
void naive_solution4(int N, vector<vector<int>> &b, vector<Point> &op1, vector<Point> &op2, int &K){
    // K = 0;
    while(K < LOOP_MAX){
        bool out = true;
        for(int i = N-2; i >= 0; i--){
...
void naive_solution_smaller_select1(int N, vector<vector<int>> &b, vector<Point> &op1, vector<Point> &op2, int &K){
    // K = 0;
    while(K < LOOP_MAX){
        bool out = true;
        for(int i = 0; i < N-1; i++){
...
void naive_solution_smaller_select2(int N, vector<vector<int>> &b, vector<Point> &op1, vector<Point> &op2, int &K){
    // K = 0;
    while(K < LOOP_MAX){
        bool out = true;
        for(int i = N-2; i >= 0; i--){
...
void naive_solution_smaller_select3(int N, vector<vector<int>> &b, vector<Point> &op1, vector<Point> &op2, int &K){
    // K = 0;
    while(K < LOOP_MAX){
        bool out = true;
        for(int i = 0; i < N-1; i++){
...
void naive_solution_smaller_select4(int N, vector<vector<int>> &b, vector<Point> &op1, vector<Point> &op2, int &K){
    // K = 0;
    while(K < LOOP_MAX){
        bool out = true;
        for(int i = N-2; i >= 0; i--){
...
int main() {
    ...
    naive_solution1(N, pre_ans, ans_op1, ans_op2, ans_K);
    ...
    // スコープ分け
    {
        ...
        int K = 0;
        naive_solution2(N, now_ans, op1, op2, K);
...

    {
        ...
        vector<vector<int>> now_ans = b;
        int K = 0;
        naive_solution3(N, now_ans, op1, op2, K);
...

    {
        ...
        vector<vector<int>> now_ans = b;
        int K = 0;
        naive_solution4(N, now_ans, op1, op2, K);
...

    {
        ...
        vector<vector<int>> now_ans = b;
        int K = 0;
        naive_solution_smaller_select1(N, now_ans, op1, op2, K);
...

    {
        ...
        vector<vector<int>> now_ans = b;
        int K = 0;
        naive_solution_smaller_select2(N, now_ans, op1, op2, K);
...

    {
        ...
        vector<vector<int>> now_ans = b;
        int K = 0;
        naive_solution_smaller_select3(N, now_ans, op1, op2, K);
...

    {
        ...
        vector<vector<int>> now_ans = b;
        int K = 0;
        naive_solution_smaller_select4(N, now_ans, op1, op2, K);
    ...
    while(sw.GetTimeMS() < 1985){
        vector<Point> op1, op2;
        vector<vector<int>> now_ans = b;
        int K = 0;
        random_select_cnt_upper = xRnd(1, 3);

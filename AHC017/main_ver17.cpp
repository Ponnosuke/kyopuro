/*
    ...
    ver12から継承、次数の頂点だけをターゲットにして、そこから全頂点への経路を求めてそれによって評価
*/
...
int main() {
    ...
    */
    ...
    while(!stop){
        ...
        int prev_day = r[target_edge_idx];
        ...
        i64 judge_value = get_sum_d_mono_diff(N, prev_day_prev_d_mono, prev_day_next_d_mono) + get_sum_d_mono_diff(N, next_day_prev_d_mono, next_day_next_d_mono);

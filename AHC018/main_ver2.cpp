...
int main() {
    ...
    int min_index = pos_to_index(Pos(N-1, N-1), N);
    ...
    for(int i = 0; i < W; i++){
        ...
        min_index = min(min_index, pos_to_index(Pos(ia, ib), N));
    }
    ...
    for(int i = 0; i < K; i++){
        ...
        min_index = min(min_index, pos_to_index(Pos(ic, id), N));
    }

    int y, x, P = 100;
    int now_index = min_index;
    int r;
    while(true){

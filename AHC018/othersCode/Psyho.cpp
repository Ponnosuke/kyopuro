...
// [DONE] - when digging take surround into account (important when next to the water/scanned cell)
// [DONE] - try different shapes of grids
// [DONE] - support multiple starts
// [DONE] - refactor to make a global grid

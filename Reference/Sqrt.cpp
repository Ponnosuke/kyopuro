...
/*
    ...
    sqrt() は組み込み関数のもの。double を返すやつ。
*/
i64 ceilSqrt2(i64 n2, i64 upperBound){
...
int main() {
    ...
    cin >> N;
    i64 num = ceilSqrt(N);
    i64 num2 = ceilSqrt2(N, INF);
    i64 num3 = floorSqrt(N, INF);
    cout << "ceilSqrt(" << N << ") = " << num << '\n';
    cout << "ceilSqrt2(" << N << ", " << INF << ") = " << num2 << '\n';
    cout << "floorSqrt(" << N << ", " << INF << ") = " << num3 << '\n';
    cout << "sqrt(" << N << ") = " << sqrt((double)N) << '\n';
    cout << num2 << " * " << num2 << " = " << num2*num2 << '\n';
    cout << num3 << " * " << num3 << " = " << num3*num3 << '\n';
